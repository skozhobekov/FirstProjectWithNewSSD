...
public void prepareForRun() {
    ...
    public void Authorized() throws InterruptedException {
        ...
        new WebDriverWait(driver,5).until(ExpectedConditions.presenceOfElementLocated(By.xpath("//*[@id=\"__layout\"]/div/header/div/div[4]/a[2]/img")));

        driver.findElement(By.xpath("//*[@id=\"__layout\"]/div/header/div/div[4]/a[2]/img")).click();
        //w.until(ExpectedConditions.presenceOfElementLocated(By.xpath("/html/body/div[1]/div/div/div[2]/div/button")));
        WebElement cookieButton = driver.findElement(By.xpath("/html/body/div[1]/div/div/div[2]/div/button"));
        cookieButton.click();
        new WebDriverWait(driver, 5).until(ExpectedConditions.presenceOfElementLocated(By.cssSelector("#__layout > div > div.using-cookie > div")));
        driver.findElement(By.cssSelector("#__layout > div > div.using-cookie > div")).click();
        ...
        Thread.sleep(2000);
        //exitButton.click();
        //WebElement exitConfirmButton = driver.findElement(By.xpath("/html/body/div[1]/div/div/div[2]/div[2]/div[2]/button[1]"));

        //exitButton.click();
        //new  WebDriverWait(driver, 5).until(ExpectedConditions.presenceOfElementLocated(By.xpath("/html/body/div[1]/div/div/div[2]/div[2]")));
    ...
    public void QuitTest() throws InterruptedException {
        //driver.get(SITE_ADDRESS);
        Thread.sleep(5000);
        new WebDriverWait(driver, 10).until(ExpectedConditions.elementToBeClickable(By.xpath("/html/body/div[1]/div/div/header/div/div[4]/a[2]")));
